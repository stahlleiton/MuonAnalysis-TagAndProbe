...
process.source = cms.Source("PoolSource", 
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/himc/HINppWinter16DR/JpsiMM_5p02TeV_TuneCUETP8M1/AODSIM/75X_mcRun2_asymptotic_ppAt5TeV_v3_ext1-v1/00000/00008A3E-E055-E611-A79E-0025904C66F0.root'),
)
...
HighPtTriggerFlags = cms.PSet(
   HIL2Mu5_NHitQ10 = cms.string("!triggerObjectMatchesByPath('HLT_HIL2Mu5_NHitQ10ForPPRef_v*',1,0).empty()"),
   HIL3Mu5_NHitQ15 = cms.string("!triggerObjectMatchesByPath('HLT_HIL3Mu5_NHitQ15ForPPRef_v*',1,0).empty()"),
...
LowPtTriggerFlags = cms.PSet(
   HIL2Mu3_NHitQ10 = cms.string("!triggerObjectMatchesByPath('HLT_HIL2Mu3_NHitQ10ForPPRef_v*',1,0).empty()"),
   HIL3Mu3_NHitQ15 = cms.string("!triggerObjectMatchesByPath('HLT_HIL3Mu3_NHitQ15ForPPRef_v*',1,0).empty()"),
)

TrigTagFlags = cms.PSet(HighPtTriggerFlags, LowPtTriggerFlags)

TrigProbeFlags = cms.PSet(
      HLTL1v0 = cms.string("!triggerObjectMatchesByPath('HLT_HIL1DoubleMu0ForPPRef_v*',1,0).empty()"),
      HLTL1v1 = cms.string("!triggerObjectMatchesByFilter('hltHIDoubleMu0L1Filtered').empty()"),
      HLTL1v2 = cms.string("(!triggerObjectMatchesByPath('HLT_HIL1DoubleMu0ForPPRef_v*',1,0).empty() && !triggerObjectMatchesByFilter('hltHIDoubleMu0L1Filtered').empty())"),
      )

process.tagMuons = cms.EDFilter("PATMuonSelector",
    src = cms.InputTag("patMuonsWithTrigger"),
    cut = cms.string(InAcceptance + ' && ' + HybridSoftId
       + " && (!triggerObjectMatchesByPath('HLT_HIL2Mu3_NHitQ10ForPPRef_v*',1,0).empty()"
       + "|| !triggerObjectMatchesByPath('HLT_HIL3Mu3_NHitQ15ForPPRef_v*',1,0).empty()"
       + "|| !triggerObjectMatchesByPath('HLT_HIL2Mu5_NHitQ10ForPPRef_v*',1,0).empty()"
       + "|| !triggerObjectMatchesByPath('HLT_HIL3Mu5_NHitQ15ForPPRef_v*',1,0).empty()"
       + "|| !triggerObjectMatchesByPath('HLT_HIL2Mu7_NHitQ10ForPPRef_v*',1,0).empty()"
       + "|| !triggerObjectMatchesByPath('HLT_HIL3Mu7_NHitQ15ForPPRef_v*',1,0).empty()"
       + "|| !triggerObjectMatchesByPath('HLT_HIL2Mu15ForPPRef_v*',1,0).empty()"
       + "|| !triggerObjectMatchesByPath('HLT_HIL3Mu15ForPPRef_v*',1,0).empty()"
       + "|| !triggerObjectMatchesByPath('HLT_HIL2Mu20ForPPRef_v*',1,0).empty()"
       + "|| !triggerObjectMatchesByPath('HLT_HIL3Mu20ForPPRef_v*',1,0).empty()"
       + ")"
       ),
)
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("tnpJPsi_MC_pp5TeV_AOD.root"))
