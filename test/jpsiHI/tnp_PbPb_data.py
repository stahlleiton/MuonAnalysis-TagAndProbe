...
LowPtTriggerTagFlags = cms.PSet(
    # Single Muon Trigger Paths
    HLT_HIL2Mu3_NHitQ15 = cms.string("!triggerObjectMatchesByPath('HLT_HIL2Mu3_NHitQ15*_v*',1,0).empty()"),
    HLT_HIL2Mu5_NHitQ15 = cms.string("!triggerObjectMatchesByPath('HLT_HIL2Mu5_NHitQ15*_v*',1,0).empty()"),
    HLT_HIL2Mu7_NHitQ15 = cms.string("!triggerObjectMatchesByPath('HLT_HIL2Mu7_NHitQ15*_v*',1,0).empty()"),
