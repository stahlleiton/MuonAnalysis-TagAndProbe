...
void closure2016pp() {
   ...
   TFile *ftnp_trg = new TFile("tnpfiles/tnp_Ana_Trg_MC_pp_12122016_pol1_pT20_v2.root");
   ...
   tr->GetUpperPad()->cd();
   tleg->Draw();
   c1->SaveAs("pp_trg_binned_12_18.pdf");
   ...
   tr->GetUpperPad()->cd();
   tleg->Draw();
   c1->SaveAs("pp_trg_binned_18_21.pdf");
   ...
   tr->GetUpperPad()->cd();
   tleg->Draw();
   c1->SaveAs("pp_trg_binned_21_24.pdf");
   ...
   TF1 *fpp_trg = new TF1("fpp_trg_00_12",tnp_mc_trg_pp_wrapper,ptminval,30,2);
   fpp_trg->SetLineColor(kRed);
   fpp_trg->SetParameter(0,y);
   hnum = (TH1D*) f->Get("hnumglbIDtrg_00_12");
   hden = (TH1D*) f->Get("hnumglbID_00_12");
   eff->Divide(hnum,hden,"pois");
   eff->SetLineColor(kBlack);
   ...
   fpp_trg->Draw("same");
   tleg->Draw();
   c1->SaveAs("pp_trg_00_12.pdf");

   // 1.2<|y|<1.8
   c1->cd(); c1->Clear();
   y=1.8-1e-4; ptminval = ptmin(y);
   fpp_trg = new TF1("fpp_trg_12_18",tnp_mc_trg_pp_wrapper,ptminval,30,2);
   fpp_trg->SetLineColor(kRed);
   fpp_trg->SetParameter(0,y);
   hnum = (TH1D*) f->Get("hnumglbIDtrg_12_18");
   hden = (TH1D*) f->Get("hnumglbID_12_18");
   ...
   fpp_trg->Draw("same");
   tleg->Draw();
   c1->SaveAs("pp_trg_12_18.pdf");

   // 1.8<|y|<2.1
   c1->cd(); c1->Clear();
   y=2.1-1e-4; ptminval = ptmin(y);
   fpp_trg = new TF1("fpp_trg_18_21",tnp_mc_trg_pp_wrapper,ptminval,20,2);
   fpp_trg->SetLineColor(kRed);
   fpp_trg->SetParameter(0,y);
   hnum = (TH1D*) f->Get("hnumglbIDtrg_18_21");
   hden = (TH1D*) f->Get("hnumglbID_18_21");
   ...
   fpp_trg->Draw("same");
   tleg->Draw();
   c1->SaveAs("pp_trg_18_21.pdf");

   // 2.1<|y|<2.4
   c1->cd(); c1->Clear();
   y=2.4-1e-4; ptminval = ptmin(y);
   fpp_trg = new TF1("fpp_trg_21_24",tnp_mc_trg_pp_wrapper,ptminval,20,2);
   fpp_trg->SetLineColor(kRed);
   fpp_trg->SetParameter(0,y);
   hnum = (TH1D*) f->Get("hnumglbIDtrg_21_24");
   hden = (TH1D*) f->Get("hnumglbID_21_24");
