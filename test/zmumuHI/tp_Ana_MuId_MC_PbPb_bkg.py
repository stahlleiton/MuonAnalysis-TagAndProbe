...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("tnp_Ana_MC_MuId_PbPb_bkg_%s.root" % scenario),
    ...
    cbGausFixedNExp = cms.vstring(
        "RooCBShape::res(mass, peak[0], sigma[1.7,0.01,10], alpha[1.8,0,5], n[1.02])", #n fixed to integral bin MC
        "Gaussian::gaus(mass, mean[91.2,81.2,101.2], sigmaG[2.495,1,20])",
        "FCONV::signal(mass, bw, gaus)",
		"Exponential::backgroundPass(mass, lp[0,-5,5])",
		"Exponential::backgroundFail(mass, lf[0,-5,5])",
		"efficiency[0.9,0.5,1]",
		"signalFractionInPassing[0.9]",
