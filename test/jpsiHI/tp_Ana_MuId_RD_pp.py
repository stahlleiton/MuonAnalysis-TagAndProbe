...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    InputFileNames = cms.vstring("/home/llr/cms/falmagne/TnP/CMSSW_9_4_10/src/MuonAnalysis/TagAndProbe/test/crab_projects/crab_TNP_SingleMu_pp5TeVRun2017G_PromptReco_v1_AOD_20181030/results/tnpJPsi_Data_pp5TeVRun2017G_AOD_partial.root"),#file:/afs/cern.ch/work/v/vabdulla/private/TnP/tnpJPsi_Data_pp5TeV_AOD_dxyzflags.root");
    InputDirectoryName = cms.string("tpTree"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("tnpJpsi_fitOutput_MuId.root"),#file:/afs/cern.ch/work/v/vabdulla/private/TnP/MuId/tnp_Ana_MuonID_RD_pp_16022017_pol1.root"),
    ...
    Categories = cms.PSet(
                          ...
                          HLTL1v0   = cms.vstring("HLTL1_DoubleMu0_v0", "dummy[true=1,false=0]"),
                          HLTL1v1   = cms.vstring("HLTL1_DoubleMu0_v1", "dummy[true=1,false=0]"),
                          HLTL1v2   = cms.vstring("HLTL1_DoubleMu0_v2", "dummy[true=1,false=0]"),
