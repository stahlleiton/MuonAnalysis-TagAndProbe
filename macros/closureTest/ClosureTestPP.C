...
const int trg_tag1 = pow(2,5);
const int trg_tag2 = pow(2,6);
const int trg_tag3 = pow(2,7);
const int trg_tag4 = pow(2,8);
const int trg_tag5 = pow(2,9);
const int trg_tag6 = pow(2,10);
const int trg_probe = pow(2,0);
const double drmax = 0.1;
const double mumass = 105.6583715e-3;

// define the bins
double bins_00_12[12] = {3.5, 4, 4.5, 5, 5.5, 6, 7, 8, 10.5, 14, 18, 30};
double bins_12_18[12] = {2.4, 3, 3.5, 4, 4.5, 5, 6, 7, 9, 14, 18, 30};
double bins_18_21[12] = {1.8, 2.5, 3, 3.5, 4, 4.5, 5, 6, 7, 9, 13, 20};
double bins_21_24[11] = {1.8, 2.5, 3, 3.5, 4, 4.5, 5, 6.5, 8.5, 12, 20};
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   f->cd();
   TH1D *hden_00_12 = new TH1D("hden_00_12","hden_00_12",11,bins_00_12);
   TH1D *hden_stawt_00_12 = new TH1D("hden_stawt_00_12","hden_stawt_00_12",11,bins_00_12);
   TH1D *hden_staIDwt_00_12 = new TH1D("hden_staIDwt_00_12","hden_staIDwt_00_12",11,bins_00_12);
   TH1D *hden_staIDtrgwt_00_12 = new TH1D("hden_staIDtrgwt_00_12","hden_staIDtrgwt_00_12",11,bins_00_12);
   TH1D *hnumglb_00_12 = new TH1D("hnumglb_00_12","hnumglb_00_12",11,bins_00_12);
   TH1D *hnumglbID_00_12 = new TH1D("hnumglbID_00_12","hnumglbID_00_12",11,bins_00_12);
   TH1D *hnumglbIDtrg_00_12 = new TH1D("hnumglbIDtrg_00_12","hnumglbIDtrg_00_12",11,bins_00_12);
   
   TH1D *hden_12_18 = new TH1D("hden_12_18","hden_12_18",11,bins_12_18);
   TH1D *hden_stawt_12_18 = new TH1D("hden_stawt_12_18","hden_stawt_12_18",11,bins_12_18);
   TH1D *hden_staIDwt_12_18 = new TH1D("hden_staIDwt_12_18","hden_staIDwt_12_18",11,bins_12_18);
   TH1D *hden_staIDtrgwt_12_18 = new TH1D("hden_staIDtrgwt_12_18","hden_staIDtrgwt_12_18",11,bins_12_18);
   TH1D *hnumglb_12_18 = new TH1D("hnumglb_12_18","hnumglb_12_18",11,bins_12_18);
   TH1D *hnumglbID_12_18 = new TH1D("hnumglbID_12_18","hnumglbID_12_18",11,bins_12_18);
   TH1D *hnumglbIDtrg_12_18 = new TH1D("hnumglbIDtrg_12_18","hnumglbIDtrg_12_18",11,bins_12_18);
   
   TH1D *hden_18_21 = new TH1D("hden_18_21","hden_18_21",11,bins_18_21);
   TH1D *hden_stawt_18_21 = new TH1D("hden_stawt_18_21","hden_stawt_18_21",11,bins_18_21);
   TH1D *hden_staIDwt_18_21 = new TH1D("hden_staIDwt_18_21","hden_staIDwt_18_21",11,bins_18_21);
   TH1D *hden_staIDtrgwt_18_21 = new TH1D("hden_staIDtrgwt_18_21","hden_staIDtrgwt_18_21",11,bins_18_21);
   TH1D *hnumglb_18_21 = new TH1D("hnumglb_18_21","hnumglb_18_21",11,bins_18_21);
   TH1D *hnumglbID_18_21 = new TH1D("hnumglbID_18_21","hnumglbID_18_21",11,bins_18_21);
   TH1D *hnumglbIDtrg_18_21 = new TH1D("hnumglbIDtrg_18_21","hnumglbIDtrg_18_21",11,bins_18_21);
   
   TH1D *hden_21_24 = new TH1D("hden_21_24","hden_21_24",10,bins_21_24);
   TH1D *hden_stawt_21_24 = new TH1D("hden_stawt_21_24","hden_stawt_21_24",10,bins_21_24);
   TH1D *hden_staIDwt_21_24 = new TH1D("hden_staIDwt_21_24","hden_staIDwt_21_24",10,bins_21_24);
   TH1D *hden_staIDtrgwt_21_24 = new TH1D("hden_staIDtrgwt_21_24","hden_staIDtrgwt_21_24",10,bins_21_24);
   TH1D *hnumglb_21_24 = new TH1D("hnumglb_21_24","hnumglb_21_24",10,bins_21_24);
   TH1D *hnumglbID_21_24 = new TH1D("hnumglbID_21_24","hnumglbID_21_24",10,bins_21_24);
   TH1D *hnumglbIDtrg_21_24 = new TH1D("hnumglbIDtrg_21_24","hnumglbIDtrg_21_24",10,bins_21_24);
      ...
      for (int igen=0; igen<Gen_QQ_size; igen++) {
         ...
         if (isgenpltag && isGlobalMuonInAccept2015(&genmi)) {
            ...
            if (fabs(geneta)<1.2) {
               ...
               totweight *= tnp_mc_sta_pp(genpt,geneta)*tnp_mc_trk_pp();
               hden_stawt_00_12->Fill(genpt,totweight);
               totweight *= tnp_mc_muid_pp(genpt,geneta);
               hden_staIDwt_00_12->Fill(genpt,totweight);
               totweight *= tnp_mc_trg_pp(genpt,geneta);
