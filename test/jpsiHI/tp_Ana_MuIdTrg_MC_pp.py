...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("file:./tnp_fitOutput_MuonIDTrigger_MC_pp_09042019_pol1.root"),
    ...
    Variables = cms.PSet(
                         ...
                         #event            = cms.vstring("Events", "0", "150000000", ""),
    ),
    ...
    PDFs = cms.PSet(
        ...
        CBGPlusPol1 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.16], sigma1[0.025, 0.019, 0.1], alpha[2.1, 0.1, 50.0], n[3.0, 0.1, 50.])",
        ...
        CBGPlusPol2 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.025, 0.008, 0.1], alpha[2.1, 0.5, 50.0], n[3.0, 0.1, 50.])",
            "Gaussian::signal2(mass, mean, sigma2[0.04, 0.01, 0.3])",
            "SUM::signal(vFrac[0.6,0.0,1.0]*signal1, signal2)",
            "Chebychev::backgroundPass(mass, {cPass[-1,-2.0,2.0], cPass2[0,-2.0,2.0]})",
            "Chebychev::backgroundFail(mass, {cFail[-1,-2.0,2.0], cFail2[0,-2.0,2.0]})",
            "efficiency[0.9,0.0,1.0]",
            "signalFractionInPassing[0.9]"            
        ),
    ),
    ...
    # there will be a separate output directory for each calculation that includes a simultaneous fit, side band subtraction and counting. 
     Efficiencies = cms.PSet(
         MuIdTrg_1bin = cms.PSet(
             EfficiencyCategoryAndState = cms.vstring("HybridSoftId_2018","true","HLTL1_DoubleMu0_v0","true","HLTL1_DoubleMu0_v2","true","passedDXY_SOFT","true","passedDZ_SOFT","true"),
             UnbinnedVariables = cms.vstring("mass"),
             BinnedVariables = cms.PSet(
                 pt = cms.vdouble(1.5, 30),
                 eta = cms.vdouble(-2.4, 2.4),
                 InAcceptance_2018_Tight = cms.vstring("true"),
                 #event = cms.vuint64(0, 20000000),
             ),
         ...
         MuIdTrg_abseta00_12 = cms.PSet(
            ...
            BinnedVariables = cms.PSet(
                 ...
                 #pt = cms.vdouble(3.5, 3.75, 4, 4.25, 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 8, 8.5, 9.5, 10.5, 12, 16, 30),
         ...
         MuIdTrg_abseta12_18 = cms.PSet(
             ...
             BinnedVariables = cms.PSet(
                 ...
                 #pt = cms.vdouble(2.4, 2.7, 3, 3.25, 3.5, 4, 4.5, 5, 5.5, 6, 6.5, 7, 9, 14, 30),
                 pt = cms.vdouble(2.06,2.4, 2.7, 3, 3.25, 3.5, 3.75, 4, 4.25, 4.5, 4.75, 5, 5.5, 6, 6.5, 7, 8, 9, 11.5, 14, 16, 18, 24, 30),
         ...
         MuIdTrg_abseta18_21 = cms.PSet(
             ...
             BinnedVariables = cms.PSet(
                 ...
                 #pt = cms.vdouble(1.8, 2, 2.25, 2.5, 2.75, 3, 3.25, 3.5, 4, 4.5, 5, 5.5, 6, 6.5, 7, 9.0, 14, 30),
                 pt = cms.vdouble(1.5,1.85, 2.2, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.25, 4.5, 4.75, 5, 5.5, 6, 6.5, 7, 8, 9,10.5, 12, 14, 16, 23, 30),       
         ...
         MuIdTrg_abseta21_24 = cms.PSet(
             ...
             BinnedVariables = cms.PSet(
                 ...
                 #pt = cms.vdouble(1.8, 2, 2.25, 2.5, 2.75, 3, 3.25, 3.5, 4, 4.5, 5, 5.5, 7, 10, 30),
                 #pt = cms.vdouble(1.8, 2.15, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.25, 4.5, 4.75, 5, 6, 7, 8, 9, 10.5, 12, 14, 16, 23, 30),
                 pt = cms.vdouble(1.5,1.85, 2.2, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.25, 4.5, 4.75, 5, 5.75, 6.5, 7.5, 8.5, 9.75, 11, 12.5, 14, 22, 30),
