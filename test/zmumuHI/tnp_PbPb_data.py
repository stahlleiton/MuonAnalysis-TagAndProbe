...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/user/anstahll/TagAndProbe/PbPb2018/SKIM/SKIM_HISingleMuon_PbPb5TeV_2018_AOD_ZBoson_20190101/HISingleMuon/SKIM_HISingleMuon_PbPb5TeV_2018_AOD_ZBoson_20190101/190101_213251/0000/MuMu_M_30_Inf_PbPb5TeV_2018_AOD_SKIM_98.root'),
)
...
process.tpPairsSta = process.tpPairs.clone(decay = cms.string('tagMuons@+ probeMuonsSta@-'), cut = cms.string('30 < mass < 160'))
