...
process.triggerResultsFilter.triggerConditions = cms.vstring( 'HLT_HIL3Mu3_NHitQ10_v*' )
...
process.tagMuons = cms.EDFilter("PATMuonSelector",
    ...
    cut = cms.string(InAcceptance_2018_Tight+" && "+HybridSoftId_2018+" && !triggerObjectMatchesByPath('HLT_HIL3Mu3_NHitQ10_v*',1,0).empty()"),
)
