...
process.source = cms.Source("PoolSource", 
    fileNames = cms.untracked.vstring('file:step3_RAW2DIGI_L1Reco_RECO_100_1_mku.root'),
)
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("tnpZ_MC_PbPb_AOD.root"))
