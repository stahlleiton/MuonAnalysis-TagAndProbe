...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
 ...
 #   InputFileNames = cms.vstring("file:/afs/cern.ch/work/o/okukral/TnP_pPb/Data/PASingleMuon_PARun2016C-PromptReco-v1TnpTress_Pbpv1CentralityInfo.root"),
    #InputFileNames = cms.vstring("file:/eos/cms/store/group/phys_heavyions/okukral/TnP_pPb_2016/DYtoMuMu_EmbPOS_80X_mcRun2_pA_merged_pruned.root"),
    InputFileNames = cms.vstring("file:/eos/cms/store/group/phys_heavyions/stuli/HFWeightedPrunedMCFiles/TnP_DYtoMuMu_Embd_PU-merged_weighted.root"),
    InputDirectoryName = cms.string("tpTree"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("tnp_Ana_MC_L3Mu12_MuId_pPb_%s_PU_CB.root" % scenario),
