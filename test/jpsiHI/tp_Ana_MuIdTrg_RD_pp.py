...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("tnp_Ana_MuonIDTrg_RD_pp.root"),
    ...
    PDFs = cms.PSet(
      CBGPlusPoly2nd = cms.vstring(
        "CBShape::signal1(mass, mean[3.1,2.9,3.3], sigma1[0.025, 0.008, 0.08], alpha[2.1, 0.9, 50.0], n[3.0, 0.2, 50.])",
    ...
    Efficiencies = cms.PSet(
            ...
            MuIdTrg_etadep = cms.PSet(
                ...
                BinnedVariables = cms.PSet(
                    pt = cms.vdouble(1.5, 30),
                    eta = cms.vdouble(-2.4,-2.1,-1.6,-0.9,0.0,0.9,1.6,2.1,2.4),
                ),
                BinToPDFmap = cms.vstring(PDFName)
            ),
    )
