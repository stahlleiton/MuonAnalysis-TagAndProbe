...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    # IO parameters:
   # InputFileNames = cms.vstring("file:/afs/cern.ch/work/o/okukral/TnP_pPb/Data/PASingleMuon_PARun2016C-PromptReco-v1TnpTress_pPbv1CentralityInfo.root"),
    InputFileNames = cms.vstring("file:/afs/cern.ch/work/o/okukral/TnP_pPb/Data/RD_trees_Pbp.root"),
    InputDirectoryName = cms.string("tpTree"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("tnp_Ana_RD_Iso_Pbp_Quick.root"),
    ...
    Categories = cms.PSet(
                        ...
                        isIso_3_15 = cms.vstring("isIso_3_20", "dummy[true=1,false=0]"),
