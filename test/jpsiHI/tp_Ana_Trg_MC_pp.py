...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("file:./tnp_fitOutput_Trigger_MC_pp_09042019_pol1.root"),
    ...
    PDFs = cms.PSet(
        ...
        CBGPlusPol1 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.1,3.2], sigma1[0.03, 0.019, 0.1], alpha[2.1, 0.1, 50.0], n[3.0, 0.1, 50.])",
