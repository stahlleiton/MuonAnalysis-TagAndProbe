...
PDFName = "BWConvCBExpPol3" #VoigtExp, BWResCBExp, BWResCBCheb, VoigtPol2, BWResCBPol2, BWConvCBExpPol3
...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    # IO parameters:
    InputFileNames = cms.vstring("file:./tnpZ_MC_PbPb_Official_mod_v5.root"),
    InputDirectoryName = cms.string("tpTreeTrk"),
    InputTreeName = cms.string("fitter_tree"),
    #OutputFileName = cms.string("tnp_Ana_Data_RecoTM_PbPb.root"),
    OutputFileName = cms.string("tnp_Ana_MC_TM_PbPb_moreEta_v5_nominal_%s_noTrackCut.root" % scenario),
    ...
    Variables = cms.PSet(
                         #mass             = cms.vstring("Tag-Probe Mass", "50.0", "130.0", "GeV/c^{2}"), # Systematic mass
...
#                          PF  = cms.vstring("PF", "dummy[true=1, false=0]"),
	...
	VoigtPol2 = cms.vstring(
		"Voigtian::signal(mass, mean[91.2,81.2,101.2], width[3.6,0.5,10], sigma[2.3,0.1,10])", # mean 85-95, width, sigma 1-10
