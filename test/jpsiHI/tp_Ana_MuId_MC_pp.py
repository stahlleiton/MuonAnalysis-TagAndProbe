...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("file:./tnp_fitOutput_MuonID_MC_pp_09042019_pol1.root"),
    #numbrer of CPUs to use for fitting
    NumCPU = cms.uint32(16),
    # specifies whether to save the RooWorkspace containing the data for each bin and
    # the pdf object with the initial and final state snapshots
    binnedFit = cms.bool(True),
    binsForFit = cms.uint32(35),
    ...
    PDFs = cms.PSet(
        ...
        CBGPlusPol1 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.02,3.15], sigma1[0.025, 0.019, 0.1], alpha[2.1, 0.2, 50.0], n[3.0, 0.1, 50.])",#sigma1[0.025, 0.008, 0.1]
    ...
    Efficiencies = cms.PSet(
        MuIdTrg_1bin = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("HybridSoftId_2018","true","passedDXY_SOFT","true","passedDZ_SOFT","true"),
        ...
        MuIdTrg_abseta12_18 = cms.PSet(
         ...
         MuIdTrg_abseta21_24 = cms.PSet(
             ...
             BinnedVariables = cms.PSet(
                 ...
                 pt = cms.vdouble(1.5, 2., 2.5, 3, 3.5, 4, 4.5, 5, 6.5, 8.5, 12, 20),
