...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    # IO parameters:
    InputFileNames = cms.vstring("/afs/cern.ch/user/c/chflores/work/public/TnP_2015/TP_Prod_Samples/MC_pp/tnp_Prod_pp_MC_All_16092015.root"),
    InputDirectoryName = cms.string("MuonTrk"),
    InputTreeName = cms.string("fitter_tree"),
    #numbrer of CPUs to use for fitting
    OutputFileName = cms.string("tnp_Ana_MC_PbPb_MuonTrk_AllMB_2abseta.root"),
    ...
    PDFs = cms.PSet(
      ...
      twoGaussPlusPoly6v1 = cms.vstring(
          "Gaussian::signal1(mass, mean[3.15,3.05,3.25], sigma[0.10,0.05,1.0])",
          "Gaussian::signal2(mass, mean1[3.2,3.1,3.3], sigma2[0.15,0.05,1.00])",
          "SUM::signal(vFrac[0.8,0,1]*signal1, signal2)",
          "Chebychev::backgroundPass(mass, {cP[0,-1.,1.], cP2[0,-1.,1.]})",
          "Chebychev::backgroundFail(mass, {cF[0,-1.,1.], cF2[0,-1.,1.]})",
          "efficiency[0.9,0,1]",
          "signalFractionInPassing[0.9]"
      ),
    ),
