...
PDFName = "BWResCBExp"  #BWResCBExp


VEFFICIENCYSET =cms.VPSet(
# Order: 0 total, 1 pT, 2-8 pT fits in abseta bins, 9 abseta, 10 eta, 11-12 centrality, 13 nPV, 14 nPV integrated   NOTE: IS NOT SAME AS SCENARIO
    cms.PSet(
        Iso_1bin = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("isIso_3_15","true"),
    ...
    cms.PSet(
        Iso_nPV_integ = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("isIso_3_15","true"),
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
                pt = cms.vdouble(15, 200),
                eta = cms.vdouble(-2.4, 2.4),
                tag_nVertices    = cms.vdouble(0.5,10.5),
                TightId = cms.vstring("true"),
                #hltL3fL1sSingleMu7BptxANDL1f0L2f0L3Filtered12 = cms.vstring("true"),
                hltL3fL1sSingleMu7BptxANDL1f0L2f0L3Filtered15 = cms.vstring("true"),
            ),
...
if scenario == "9": EFFICIENCYSET = cms.PSet(VEFFICIENCYSET[13], VEFFICIENCYSET[14])
if scenario == "0": EFFICIENCYSET = cms.PSet(VEFFICIENCYSET[0],VEFFICIENCYSET[1],VEFFICIENCYSET[2], VEFFICIENCYSET[3],VEFFICIENCYSET[4], VEFFICIENCYSET[5],VEFFICIENCYSET[6], VEFFICIENCYSET[7],VEFFICIENCYSET[8], VEFFICIENCYSET[9], VEFFICIENCYSET[10],VEFFICIENCYSET[11],VEFFICIENCYSET[12],VEFFICIENCYSET[13], VEFFICIENCYSET[14])
...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
 ...
 #   InputFileNames = cms.vstring("file:/afs/cern.ch/work/o/okukral/TnP_pPb/Data/PASingleMuon_PARun2016C-PromptReco-v1TnpTress_Pbpv1CentralityInfo.root"),
    InputFileNames = cms.vstring("file:/afs/cern.ch/work/o/okukral/TnP_pPb/Data/RD_trees-merged.root"),
    InputDirectoryName = cms.string("tpTree"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("tnp_Ana_RD_Iso_merged_%s.root" % scenario),
