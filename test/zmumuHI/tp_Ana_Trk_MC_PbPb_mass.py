...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
   ...
   # InputFileNames = cms.vstring("file:/eos/cms/store/group/phys_heavyions/dileptons/TNPTagAndProbe2018/MC2018/PbPb502TeV/tnpZ_MC_PbPb_Official_mod_v5.root"),
    InputFileNames = cms.vstring("file:/afs/cern.ch/work/o/okukral/TnP_PbPb/CMSSW_10_3_2/src/MuonAnalysis/TagAndProbe/test/zmumuHI/tnpZ_MC_PbPb_Official_mod_v5_1.root"),
    InputDirectoryName = cms.string("tpTreeTrk"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("tnp_Ana_MC_TrkfromTrkM5_PbPb_mass_%s.root" % scenario),
    #numbrer of CPUs to use for fitting
    NumCPU = cms.uint32(16),
    # specifies whether to save the RooWorkspace containing the data for each bin and
    # the pdf object with the initial and final state snapshots
    binnedFit = cms.bool(True),
    binsForFit = cms.uint32(70),
    binsForMassPlots = cms.uint32(70),
    SaveWorkspace = cms.bool(False),
    WeightVariable = cms.string("weight"),
    
    # defines all the real variables of the probes available in the input tree and intended for use in the efficiencies
    Variables = cms.PSet(
                         mass             = cms.vstring("Tag-Probe Mass", "65.0", "135.0", "GeV/c^{2}"), # mass range syst:   65 135
    ...
    cbFixedNGausPol3 = cms.vstring( #n , alpha fixed to integrated bin in MC 
        ...
        "RooFormulaVar::sigma2('@0*@1',{fracS[1.6,1.0,2.4],sigma1})",
