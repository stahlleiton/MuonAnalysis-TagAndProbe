...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("Output/Trg/tnp_Ana_MC_PbPb_Trg_%s_%s_%sFilter_%s.root" % (filterTag, PDFName, TagTrg, scenario) ), #"mass2834" for mass range systematics  #L3M310QH, L3M12
