...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("tnp_fitOutput_MuonID_data_pp_12042019_pol1.root"),#file:/afs/cern.ch/work/v/vabdulla/private/TnP/MuId/tnp_Ana_MuonID_RD_pp_16022017_pol1.root"),
    ...
    PDFs = cms.PSet(
        ...
        CBGPlusPol1 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.02,3.15], sigma1[0.025, 0.018, 0.1], alpha[2.1, 0.2, 50.0], n[3.0, 0.1, 50.])",
            "Gaussian::signal2(mass, mean, sigma2[0.04, 0.013, 0.3])",
    ...
    Efficiencies = cms.PSet(
        ...
        MuIdTrg_abseta00_12 = cms.PSet(
            ...
            BinnedVariables = cms.PSet(
                ...
                pt = cms.vdouble(3.3, 4, 4.5, 5, 5.5, 6, 7, 8, 10.5, 14, 18, 30),
         ...
         MuIdTrg_abseta12_18 = cms.PSet(
             ...
             BinnedVariables = cms.PSet(
                 ...
                 pt = cms.vdouble(2, 2.4, 3, 3.5, 4, 4.5, 5, 6, 7, 9, 14, 18, 30),
         ...
         MuIdTrg_abseta18_21 = cms.PSet(
             ...
             BinnedVariables = cms.PSet(
                 ...
                 pt = cms.vdouble(1.2, 1.8, 2.5, 3, 3.5, 4, 4.5, 5, 6, 7, 9, 13, 20),
         ...
         MuIdTrg_abseta21_24 = cms.PSet(
             ...
             BinnedVariables = cms.PSet(
                 ...
                 pt = cms.vdouble(1.2, 1.8, 2.5, 3, 3.5, 4, 4.5, 5, 6.5, 8.5, 12, 20),
