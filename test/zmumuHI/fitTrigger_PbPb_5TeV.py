...
process.TnP_Trigger = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
     ## Input, output 
    InputFileNames = cms.vstring("file:TnP_Z_PbPb5TeV_data_v1.root"),
    #InputFileNames = cms.vstring("file:TnP_Z_PbPb5TeV_MC_Zmu10mu10_v1.root"),
    #OutputFileName = cms.string("fits_PbPb5TeV_data_HLT_HIL2Mu15_BWResCBExp_v1.root"),
    OutputFileName = cms.string("fits_PbPb5TeV_data_HLT_HIL3Mu15_BWResCBExp_v1.root"),
    #OutputFileName = cms.string("fits_PbPb5TeV_MC_Zmu10mu10_HLT_HIL2Mu15_BWResCBExp_v1.root"),
    #OutputFileName = cms.string("fits_PbPb5TeV_MC_Zmu10mu10_HLT_HIL3Mu15_BWResCBExp_v1.root"),
    ...
    Efficiencies = cms.PSet(
        Trig_pt = cms.PSet(
            ...
            EfficiencyCategoryAndState = cms.vstring("HIL3Mu15", "pass"), ## Numerator definition
		...
		tag_hiBin = cms.vdouble( 0, 200 ),
                ...
                tag_HIL3Mu15 = cms.vstring("pass"), ## i.e. use only events for which this flag is true
