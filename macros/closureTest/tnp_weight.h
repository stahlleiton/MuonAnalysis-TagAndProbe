...
double tnp_weight_TM_pbpb(double eta)
{
  ...
  // MC
  else if (abseta >= 0 && abseta < 0.3) den = 0.990378;
  else if (abseta >= 0.3 && abseta < 0.6) den = 0.990283;
  else if (abseta >= 0.6 && abseta < 0.9) den = 0.988718;
  else if (abseta >= 0.9 && abseta < 1.2) den = 0.981338;
  else if (abseta >= 1.2 && abseta < 1.6) den = 0.985933;
  else if (abseta >= 1.6 && abseta < 2.1) den = 0.99882;
  else if (abseta >= 2.1 && abseta <= 2.4) den = 0.995412;
