...
L2Variables = cms.PSet(
    l2pt  = cms.string("? triggerObjectMatchesByCollection('hltL2MuonCandidatesPPOnAA').empty() ? 0 : triggerObjectMatchesByCollection('hltL2MuonCandidatesPPOnAA').at(0).pt"),
    l2eta = cms.string("? triggerObjectMatchesByCollection('hltL2MuonCandidatesPPOnAA').empty() ? 0 : triggerObjectMatchesByCollection('hltL2MuonCandidatesPPOnAA').at(0).eta"),
...
L3Variables = cms.PSet(
    l3pt = cms.string("? triggerObjectMatchesByCollection('hltIterL3MuonCandidatesPPOnAA').empty() ? 0 : triggerObjectMatchesByCollection('hltIterL3MuonCandidatesPPOnAA').at(0).pt"),
    l3dr = cms.string("? triggerObjectMatchesByCollection('hltIterL3MuonCandidatesPPOnAA').empty() ? 999 : "+
                      " deltaR( eta, phi, " +
                      "         triggerObjectMatchesByCollection('hltIterL3MuonCandidatesPPOnAA').at(0).eta, "+
                      "         triggerObjectMatchesByCollection('hltIterL3MuonCandidatesPPOnAA').at(0).phi ) ")
)
...
HighPtTriggerFlags = cms.PSet(
   ...
   IsoMu22_eta2p1   = cms.string("!triggerObjectMatchesByPath('HLT_IsoMu22_eta2p1_v*',1,0).empty()"),
   IsoMu24_eta2p1   = cms.string("!triggerObjectMatchesByPath('HLT_IsoMu24_eta2p1_v*',1,0).empty()"),
   ...
   IsoTkMu22_eta2p1 = cms.string("!triggerObjectMatchesByPath('HLT_IsoTkMu22_eta2p1_v*',1,0).empty()"),
   ...
   DoubleIsoMu17Mu8_IsoMu8leg = cms.string("!triggerObjectMatchesByFilter('hltDiMuonGlb17Glb8RelTrkIsoFiltered0p4').empty() && (!triggerObjectMatchesByFilter('hltL3pfL1sDoubleMu114L1f0L2pf0L3PreFiltered8').empty()||!triggerObjectMatchesByFilter('hltL3pfL1sDoubleMu114ORDoubleMu125L1f0L2pf0L3PreFiltered8').empty())"),
   DoubleIsoMu17Mu8_Mu8leg = cms.string("(!triggerObjectMatchesByFilter('hltL3pfL1sDoubleMu114L1f0L2pf0L3PreFiltered8').empty()||!triggerObjectMatchesByFilter('hltL3pfL1sDoubleMu114ORDoubleMu125L1f0L2pf0L3PreFiltered8').empty())"),
...
HighPtTriggerFlagsDebug = cms.PSet(
   ...
   #add the filter for muon 22 path familly
   hltL2fL1sMu20L1f0L2Filtered10Q = cms.string("!triggerObjectMatchesByFilter('hltL2fL1sMu22L1f0L2Filtered10Q').empty()"),
   hltL3fL1sMu20L1f0L2f10QL3Filtered22Q = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu20L1f0L2f10QL3Filtered22Q').empty()"),
   hltL3fL1sMu20L1f0L2f10QL3Filtered22QL3pfecalIsoRhoFilteredEB0p11EE0p08 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu20L1f0L2f10QL3Filtered22QL3pfecalIsoRhoFilteredEB0p11EE0p08').empty()"),
   hltL3fL1sMu20L1f0L2f10QL3Filtered22QL3pfhcalIsoRhoFilteredHB0p21HE0p22 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu20L1f0L2f10QL3Filtered22QL3pfhcalIsoRhoFilteredHB0p21HE0p22').empty()"),
   hltL3crIsoL1sMu20L1f0L2f10QL3f22QL3trkIsoFiltered0p09 = cms.string("!triggerObjectMatchesByFilter('hltL3crIsoL1sMu20L1f0L2f10QL3f22QL3trkIsoFiltered0p09').empty()"),
   hltL3fL1sMu20f0TkFiltered22Q = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu20f0TkFiltered22Q').empty()"),
   hltL3fL1sMu20f0TkFiltered22QL3pfecalIsoRhoFilteredEB0p11EE0p08 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu20f0TkFiltered22QL3pfecalIsoRhoFilteredEB0p11EE0p08').empty()"),
   hltL3fL1sMu20f0TkFiltered22QL3pfhcalIsoRhoFilteredHB0p21HE0p22 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu20f0TkFiltered22QL3pfhcalIsoRhoFilteredHB0p21HE0p22').empty()"),
   hltL3fL1sMu20L1f0Tkf22QL3trkIsoFiltered0p09 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu20L1f0Tkf22QL3trkIsoFiltered0p09').empty()"),

   #add the filter for muon 24 path familly
   hltL2fL1sMu22L1f0L2Filtered10Q = cms.string("!triggerObjectMatchesByFilter('hltL2fL1sMu22L1f0L2Filtered10Q').empty()"),
   hltL3fL1sMu22L1f0L2f10QL3Filtered24Q = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu22L1f0L2f10QL3Filtered24Q').empty()"),
   hltL3fL1sMu22L1f0L2f10QL3Filtered24QL3pfecalIsoRhoFilteredEB0p11EE0p08 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu22L1f0L2f10QL3Filtered24QL3pfecalIsoRhoFilteredEB0p11EE0p08').empty()"),
   hltL3fL1sMu22L1f0L2f10QL3Filtered24QL3pfhcalIsoRhoFilteredHB0p21HE0p22 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu22L1f0L2f10QL3Filtered24QL3pfhcalIsoRhoFilteredHB0p21HE0p22').empty()"),
   hltL3crIsoL1sMu22L1f0L2f10QL3f24QL3trkIsoFiltered0p09 = cms.string("!triggerObjectMatchesByFilter('hltL3crIsoL1sMu22L1f0L2f10QL3f24QL3trkIsoFiltered0p09').empty()"),
   hltL3fL1sMu22f0TkFiltered24Q = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu22f0TkFiltered24Q').empty()"),
   hltL3fL1sMu22f0TkFiltered24QL3pfecalIsoRhoFilteredEB0p11EE0p08 = cms.string("!triggerObjectMatchesByFilter('hltL3crIsoL1sMu22L1f0L2f10QL3f24QL3trkIsoFiltered0p09').empty()"),
