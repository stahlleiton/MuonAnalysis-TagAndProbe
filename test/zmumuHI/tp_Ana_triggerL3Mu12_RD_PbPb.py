	...
	cms.PSet(
			Trg_rundep = cms.PSet(
				...
				BinnedVariables = cms.PSet(
					...
					#run = cms.vdouble(326381, 326618, 326791, 327312, 327564),
					#run = cms.vdouble(326381, 326617, 327564),
					#run = cms.vdouble(326381, 326499, 326618, 326704, 326791, 326921, 327051, 327181, 327312, 327438, 327564),
...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
 ...
 #   InputFileNames = cms.vstring("file:/afs/cern.ch/work/o/okukral/TnP_pPb/Data/PASingleMuon_PARun2016C-PromptReco-v1TnpTress_Pbpv1CentralityInfo.root"),
    ...
    OutputFileName = cms.string("tnp_Ana_RD_L3Mu12_PbPb_%s_v2_syst.root" % scenario),
    ...
    Variables = cms.PSet(
                         #mass   = cms.vstring("Tag-Probe Mass", "60.0", "135.0", "GeV/c^{2}"), # mass range syst: 2.8-3.4
