...
process.source = cms.Source("PoolSource", 
    fileNames = cms.untracked.vstring('/store/data/Run2017G/SingleMuon/AOD/17Nov2017-v1/910000/E4B056C8-3031-E811-9D14-001E67E6F490.root'),#/store/himc/RunIIpp5Spring18DR/JPsiMM_TuneCUETP8M1_5p02TeV_pythia8/AODSIM/94X_mc2017_realistic_forppRef5TeV-v2/60000/FC0EFD70-DC46-E911-BF6B-1418774117C7.root'),
)
...
process.GlobalTag.globaltag = cms.string('94X_mc2017_realistic_forppRef5TeV')
...
HybridSoftId = "isTrackerMuon && isGlobalMuon && track.hitPattern.trackerLayersWithMeasurement > 5 && track.hitPattern.numberOfValidPixelHits > 0" # && muonID('TMOneStationTight') ---> is removed
...
process.probeMuonsTrk = cms.EDFilter("PATMuonSelector",
    src = cms.InputTag("patMuonsWithTrigger"),
    cut = cms.string(TRACK_CUTS + ' && ' + InLooseAcceptance + ' && ' + 'innerTrack.isNonnull && innerTrack.originalAlgo<13'), #   muonSeededStepInOut = 13              
)
