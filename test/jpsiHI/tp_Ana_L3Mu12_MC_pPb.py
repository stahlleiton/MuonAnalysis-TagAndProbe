...
# Order: 0 total, 1 pT, 2-4 pT fits in abseta bins, 5 abseta   NOTE: IS NOT SAME AS SCENARIO
    cms.PSet(
        L3Mu12_1bin = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("HLT_PAL3Mu12","true"),
            UnbinnedVariables = cms.vstring("mass", "weight"),
            BinnedVariables = cms.PSet(
                pt = cms.vdouble(10.0, 30.0),
                eta = cms.vdouble(-2.4, 2.4),
                tag_nVertices    = cms.vdouble(0.9,1.1),
                TightHI = cms.vstring("true"),
            ),
...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("tnp_Ana_MC_L3Mu12_pPb_%s.root" % scenario),
    ...
    Categories = cms.PSet(
                        ...
                        HLT_PAL3Mu12 = cms.vstring("HLT_PAL3Mu12", "dummy[true=1,false=0]"),
