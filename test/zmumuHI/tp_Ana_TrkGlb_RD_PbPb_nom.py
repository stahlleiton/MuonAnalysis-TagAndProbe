...
if scenario == "0": EFFICIENCYSET = cms.PSet(VEFFICIENCYSET[0], VEFFICIENCYSET[1],VEFFICIENCYSET[2], VEFFICIENCYSET[3],VEFFICIENCYSET[4], VEFFICIENCYSET[5], VEFFICIENCYSET[6], VEFFICIENCYSET[7], VEFFICIENCYSET[8], VEFFICIENCYSET[9], VEFFICIENCYSET[10], VEFFICIENCYSET[11], VEFFICIENCYSET[12], VEFFICIENCYSET[13], VEFFICIENCYSET[14], VEFFICIENCYSET[15], VEFFICIENCYSET[16], VEFFICIENCYSET[17], VEFFICIENCYSET[18], VEFFICIENCYSET[19])
...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    InputFileNames = cms.vstring("file:/afs/cern.ch/work/o/okukral/TnP_PbPb/CMSSW_10_3_2/src/MuonAnalysis/TagAndProbe/test/zmumuHI/tnpZ_Data_PbPb_mod_v6.root"),
    InputDirectoryName = cms.string("tpTreeTrk"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("tnp_Ana_RD_TrkfromTrkM9_PbPb_%s.root" % scenario),  #m5->6 added TC
