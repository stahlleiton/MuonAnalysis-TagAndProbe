...
const char* fDataName[nSyst] = {
  //"/afs/cern.ch/work/v/vabdulla/private/TnP/MuIdTrg/tnp_Ana_MuonIDTrg_RD_pp_eta18_18Nov2016_pol1_v2.root",
  //"/afs/cern.ch/work/v/vabdulla/private/TnP/MuIdTrg/tnp_Ana_MuonIDTrg_RD_pp_eta18_18Nov2016_pol1_v2.root",
  //"/afs/cern.ch/work/v/vabdulla/private/TnP/Syst/MuIdTrg/tnp_Ana_MuonIDTrg_RD_pp_21Nov2016_Mass2834.root",
  //"/afs/cern.ch/work/v/vabdulla/private/TnP/Syst/MuIdTrg/tnp_Ana_MuonIDTrg_RD_pp_21Nov2016_CB.root",
  //"/afs/cern.ch/work/v/vabdulla/private/TnP/Syst/MuIdTrg/tnp_Ana_MuonIDTrg_RD_pp_eta18_18Nov2016_pol2.root",

  "/afs/cern.ch/work/v/vabdulla/private/TnP/Trg/tnp_Ana_Trg_RD_pp_23112016_pol1_v2.root",
  "/afs/cern.ch/work/v/vabdulla/private/TnP/Syst/Trg/tnp_Ana_Trg_RD_pp_28112016_Mass2834.root",
  "/afs/cern.ch/work/v/vabdulla/private/TnP/Syst/Trg/tnp_Ana_Trg_RD_pp_28112016_CB.root",
  "/afs/cern.ch/work/v/vabdulla/private/TnP/Syst/Trg/tnp_Ana_Trg_RD_pp_28112016_pol2.root",
  
};
const char* fMCName[nSyst] = {
  //"/afs/cern.ch/work/v/vabdulla/private/TnP/MuIdTrg/tnp_Ana_MuonIDTrg_MC_pp_eta18_12Nov2016_less.root", // MC same bins
  //"/afs/cern.ch/work/v/vabdulla/private/TnP/Trg/tnp_Ana_Trg_MC_pp_18112016.root",
  //"/afs/cern.ch/work/v/vabdulla/private/TnP/Trg/tnp_Ana_Trg_MC_pp_23112016_pol1_v2.root",
  //"/afs/cern.ch/work/v/vabdulla/private/TnP/MuIdTrg/tnp_Ana_MuonIDTrg_MC_pp_eta18_18Nov2016_2xpT_pol1_v2.root",
  //"/afs/cern.ch/work/v/vabdulla/private/TnP/Syst/MuIdTrg/tnp_Ana_MuonIDTrg_MC_pp_21Nov2016_2xpT_Mass2834.root",
  //"/afs/cern.ch/work/v/vabdulla/private/TnP/Syst/MuIdTrg/tnp_Ana_MuonIDTrg_MC_pp_21Nov2016_2xpT_CB.root",
  //"/afs/cern.ch/work/v/vabdulla/private/TnP/Syst/MuIdTrg/tnp_Ana_MuonIDTrg_MC_pp_eta18_18Nov2016_2xpT_pol2.root",


  "/afs/cern.ch/work/v/vabdulla/private/TnP/Trg/tnp_Ana_Trg_MC_pp_28112016_pol1.root",
  "/afs/cern.ch/work/v/vabdulla/private/TnP/Trg/tnp_Ana_Trg_MC_pp_28112016_pol1.root",
  "/afs/cern.ch/work/v/vabdulla/private/TnP/Trg/tnp_Ana_Trg_MC_pp_28112016_pol1.root",
  "/afs/cern.ch/work/v/vabdulla/private/TnP/Trg/tnp_Ana_Trg_MC_pp_28112016_pol1.root",
...
//TString ptTag[nAbsEtaBins] = {"MuIdTrg_abseta18_21", "MuIdTrg_abseta21_24"};
...
TString TypeTag("MuIdTrg");
//TString cutLegend("Muon ID + trigger");
TString cutLegend("Trigger");

const double effmin = 0.;
const double sfrange = 0.3; //0.55
#endif

#ifdef STA
const char* fDataName[nSyst] = {
  //"/afs/cern.ch/work/v/vabdulla/private/TnP/STA/tnp_Ana_STA_pp_RD_18eta_12Nov2016_less.root",
  "/afs/cern.ch/work/v/vabdulla/private/TnP/STA/tnp_Ana_STA_pp_RD_18eta_18Nov2016_pol1.root",
  "/afs/cern.ch/work/v/vabdulla/private/TnP/Syst/STA/tnp_Ana_STA_pp_RD_21Nov2016_Mass2834.root",
  "/afs/cern.ch/work/v/vabdulla/private/TnP/Syst/STA/tnp_Ana_STA_pp_RD_21Nov2016_Gauss.root",
  "/afs/cern.ch/work/v/vabdulla/private/TnP/Syst/STA/tnp_Ana_STA_pp_RD_18eta_15Nov2016_pol2.root",
};
const char* fMCName[nSyst] = {
  //"/afs/cern.ch/work/v/vabdulla/private/TnP/STA/tnp_Ana_STA_pp_MC_18eta_15Nov2016_2xpT.root",
  "/afs/cern.ch/work/v/vabdulla/private/TnP/STA/tnp_Ana_STA_pp_MC_18eta_18Nov2016_2xpT_pol1.root",
  "/afs/cern.ch/work/v/vabdulla/private/TnP/Syst/STA/tnp_Ana_STA_pp_MC_21Nov2016_2xpT_Mass2834.root",
  "/afs/cern.ch/work/v/vabdulla/private/TnP/Syst/STA/tnp_Ana_STA_pp_MC_21Nov2016_2xpT_Gauss.root",
  "/afs/cern.ch/work/v/vabdulla/private/TnP/Syst/STA/tnp_Ana_STA_pp_MC_18eta_15Nov2016_2xpT_pol2.root",
};
...
#ifdef TRK
const char* fDataName[nSyst] = {
  "/afs/cern.ch/work/v/vabdulla/private/TnP/Trk/tnp_Ana_Trk_RD_pp_etapT.root",
};
const char* fMCName[nSyst] = {
  "/afs/cern.ch/work/v/vabdulla/private/TnP/Trk/tnp_Ana_Trk_MC_pp_etapT.root",
};
...
void TnPEffDraw_syst_play() {
  ...
  for (int i=0; i<nbins_abseta; i++)
  {
     ...
     for (int k=0; k<nSyst; k++)
     {
	  ...
	  //TString tag = absetaVar + "_bin0__pair_pt_bin0__pt_bin";
	   //__HybridSoftHI_true__dxyzPVCuts_true
           for (int j=0; j<nbins_mc; j++) {
              RooFitResult *fitres = (RooFitResult*) fMC[0]->Get(cutTag + "/" + ptTag[i] + "/" + tag + Form("%i__HybridSoftHI_true__dxyzPVCuts_true__cbGausPlusExpo/fitresults",j));
              if (!fitres) fitres = (RooFitResult*) fMC[0]->Get(cutTag + "/" + ptTag[i] + "/" + tag + Form("%i__HybridSoftHI_true__dxyzPVCuts_true__cbPlusPoly1/fitresults",j));
              if (!fitres) fitres = (RooFitResult*) fMC[0]->Get(cutTag + "/" + ptTag[i] + "/" + tag + Form("%i__HybridSoftHI_true__dxyzPVCuts_true__cbPlusPoly2/fitresults",j));
	      if (!fitres) fitres = (RooFitResult*) fMC[0]->Get(cutTag + "/" + ptTag[i] + "/" + tag + Form("%i__HybridSoftHI_true__dxyzPVCuts_true__CBGPlusPol2/fitresults",j));
	      if (!fitres) fitres = (RooFitResult*) fMC[0]->Get(cutTag + "/" + ptTag[i] + "/" + tag + Form("%i__HybridSoftHI_true__dxyzPVCuts_true__CBGPlusPol1/fitresults",j));
	      if (!fitres) fitres = (RooFitResult*) fMC[0]->Get(cutTag + "/" + ptTag[i] + "/" + tag + Form("%i__HybridSoftHI_true__dxyzPVCuts_true__cbPlusPoly2nd/fitresults",j));
              if (!fitres) fitres = (RooFitResult*) fMC[0]->Get(cutTag + "/" + ptTag[i] + "/" + tag + Form("%i__HybridSoftHI_true__dxyzPVCuts_true__cbPlusPoly3rd/fitresults",j));
              if (!fitres) fitres = (RooFitResult*) fMC[0]->Get(cutTag + "/" + ptTag[i] + "/" + tag + Form("%i__HybridSoftHI_true__dxyzPVCuts_true__cbPlusExpo/fitresults",j));
              if (!fitres) fitres = (RooFitResult*) fMC[0]->Get(cutTag + "/" + ptTag[i] + "/" + tag + Form("%i__HybridSoftHI_true__dxyzPVCuts_true__GaussPlusExpo/fitresults",j));
              if (!fitres) fitres = (RooFitResult*) fMC[0]->Get(cutTag + "/" + ptTag[i] + "/" + tag + Form("%i__HybridSoftHI_true__dxyzPVCuts_true__twoGaussPlusPol2/fitresults",j));
	      if (!fitres) fitres = (RooFitResult*) fMC[0]->Get(cutTag + "/" + ptTag[i] + "/" + tag + Form("%i__HybridSoftHI_true__dxyzPVCuts_true__twoGaussPlusPol1/fitresults",j));
              if (!fitres) fitres = (RooFitResult*) fMC[0]->Get(cutTag + "/" + ptTag[i] + "/" + tag + Form("%i__HybridSoftHI_true__dxyzPVCuts_true__GaussPlusPoly2/fitresults",j));
	   ...
	   delete[] tntot;
        ...
        // save (nominal only)
        if (k==0) {
	  c1->SaveAs(TypeTag + "/" + cutTag + Form("Eff%i_",i) + collTag + "_RD_MC_PT.root");
	  c1->SaveAs(TypeTag + "/" + cutTag + Form("Eff%i_",i) + collTag + "_RD_MC_PT.pdf");
	  c1->SaveAs(TypeTag + "/" + cutTag + Form("Eff%i_",i) + collTag + "_RD_MC_PT.png");
        }
	  ...
	  if(FitErfC){
	    fdata = new TF1("fdata","[0]*(2/TMath::Pi())*TMath::Erf((x-[1])/[2]) + [3]",ptmin,ptmax);
	    fdata->SetParNames("eff0","x0","m","C");
	    fdata->SetParLimits(3,0,100.);
	  }
	  if(FitErfExp){
	    fdata = new TF1("fdata","[0]*(TMath::Erf((x-[1])/[2])*TMath::Exp([3]*x)) + [4]",ptmin,ptmax);
	    //fdata = new TF1("fdata","[0]*(TMath::Erf((x-[1])/[2]) * TMath::Exp([3]+[4]*x))",ptmin,ptmax);
	    fdata->SetParNames("eff0","x0","m","C","#lambda");
	    fdata->SetParLimits(4,-50,50.);
	  }
	  ...
	  if(FitErfC)
	    leg1->AddEntry(fdata,Form("%0.2f*TMath::Erf((x-%0.2f)/%0.2f) + %0.2f",fdata->GetParameter(0),fdata->GetParameter(1),fdata->GetParameter(2),fdata->GetParameter(3)),"pl");
	  if(FitErfExp)
	    leg1->AddEntry(fdata,Form("%0.2f*[TMath::Erf((x-%0.2f)/%0.2f)*exp(%0.2f*x)] + %0.2f",fdata->GetParameter(0),fdata->GetParameter(1),fdata->GetParameter(2),fdata->GetParameter(3),fdata->GetParameter(4)),"pl");
	  //leg1->AddEntry(fdata,Form("%0.2f*[TMath::Erf((x-%0.2f)/%0.2f)*exp(%0.2f+%0.2f*x)]",fdata->GetParameter(0),fdata->GetParameter(1),fdata->GetParameter(2),fdata->GetParameter(3),fdata->GetParameter(4)),"pl");
           ...
           else fmc->SetParameters(ComPt0[k][i]->GetX()[ComPt0[k][i]->GetN()-1],0.1,1.0); 
	  ...
	  if(FitErfC)
	    leg1->AddEntry(fmc,Form("%0.2f*TMath::Erf((x-%0.2f)/%0.2f) + %0.2f",fmc->GetParameter(0),fmc->GetParameter(1),fmc->GetParameter(2),fmc->GetParameter(3)),"pl");
	  if(FitErfExp)
	    leg1->AddEntry(fmc,Form("%0.2f*[TMath::Erf((x-%0.2f)/%0.2f)*exp(%0.2f*x)] + %0.2f",fmc->GetParameter(0),fmc->GetParameter(1),fmc->GetParameter(2),fmc->GetParameter(3),fmc->GetParameter(4)),"pl");
	  //leg1->AddEntry(fmc,Form("%0.2f*[TMath::Erf((x-%0.2f)/%0.2f)*exp(%0.2f+%0.2f*x)]",fmc->GetParameter(0),fmc->GetParameter(1),fmc->GetParameter(2),fmc->GetParameter(3),fmc->GetParameter(4)),"pl");
	  ...
	  TF1 *fratio = NULL;
	  if(FitErf){
	    fratio = new TF1("fratio","[0]*TMath::Erf((x-[1])/[2])/([3]*TMath::Erf((x-[4])/[5]))",ptmin,ptmax);
	  ...
	  if(FitErfC){
	    fratio = new TF1("fratio","([0]*(2/TMath::Pi())*TMath::Erf((x-[1])/[2])+[3])/([4]*(2/TMath::Pi())*TMath::Erf((x-[5])/[6])+[7])",ptmin,ptmax);
	    fratio->SetParameters(fdata->GetParameter(0),fdata->GetParameter(1),fdata->GetParameter(2),fdata->GetParameter(3),
				  fmc->GetParameter(0),fmc->GetParameter(1),fmc->GetParameter(2), fmc->GetParameter(3));
	  }
	  if(FitErfExp){
	    fratio = new TF1("fratio","([0]*(TMath::Erf((x-[1])/[2])*TMath::Exp([3]*x))+[4])/([5]*(TMath::Erf((x-[6])/[7])*TMath::Exp([8]*x)) + [9])",ptmin,ptmax);
	    //fratio = new TF1("fratio","[0]*(TMath::Erf((x-[1])/[2]) * TMath::Exp([3]+[4]*x))/([5]*(TMath::Erf((x-[6])/[7]) * TMath::Exp([8]+[9]*x)))",ptmin,ptmax);
	    fratio->SetParameters(fdata->GetParameter(0),fdata->GetParameter(1),fdata->GetParameter(2),fdata->GetParameter(3), fdata->GetParameter(4),
				  fmc->GetParameter(0),fmc->GetParameter(1),fmc->GetParameter(2), fmc->GetParameter(3), fmc->GetParameter(4));
	  }
	  ...
	  // save (nominal only)
	  c1->SaveAs(TypeTag + "/" + cutTag + Form("SF%i_",i) + collTag + "_RD_MC_PT.root");
	  c1->SaveAs(TypeTag + "/" + cutTag + Form("SF%i_",i) + collTag + "_RD_MC_PT.pdf");
	  c1->SaveAs(TypeTag + "/" + cutTag + Form("SF%i_",i) + collTag + "_RD_MC_PT.png");
     ...
     // toys study 
     if (doToys) toyStudy(nSyst, graphssyst_data, graphssyst_mc, fdata, fmc, TypeTag, cutTag + Form("toys%i_",i) + collTag + "_RD_MC_PT", 0);
     //0 -> stat, 1 -> stat + syst, 2 -> do both, make plots but don't print the functions
#else
     }
  ...
  for (int k=0; k<nSyst; k++)
  {
     ...
     if (k==0) {
       c1->SaveAs(TypeTag + "/" + cutTag + "Eff_" + collTag + "_RD_MC_Eta.root");
       c1->SaveAs(TypeTag + "/" + cutTag + "Eff_" + collTag + "_RD_MC_Eta.pdf");
       c1->SaveAs(TypeTag + "/" + cutTag + "Eff_" + collTag + "_RD_MC_Eta.png");
     }
  }
  ...
  if (isPbPb) {
     ...
     c1->SaveAs(TypeTag + "/" + cutTag + "Eff_" + collTag + "_RD_MC_Cent.root");
     c1->SaveAs(TypeTag + "/" + cutTag + "Eff_" + collTag + "_RD_MC_Cent.pdf");
     c1->SaveAs(TypeTag + "/" + cutTag + "Eff_" + collTag + "_RD_MC_Cent.png");
  }
...
void plotSysts(TGraphAsymmErrors *graphs[nSyst], TCanvas *c1, TPad *p1, TH1F *h1, TPad *pr, TH1F *hr, TString header, TString tag){
   ...
   for (int k=1; k<nSyst; k++) {
	 ...
	 yr[k][j] = 1 + fabs(graphs[k]->GetY()[j] - ComPt0_forRatio->GetY()[j])/ComPt0_forRatio->GetY()[j];
	 //yr[k][j] = 1 + fabs(graphs[k]->GetY()[j] - ComPt0_forRatio->GetY()[j])/max(graphs[k]->GetY()[j], ComPt0_forRatio->GetY()[j]);
   ...
   // save
   c1->SaveAs(TypeTag + "/" + tag + ".root");
   c1->SaveAs(TypeTag + "/" + tag + ".pdf");
   c1->SaveAs(TypeTag + "/" + tag + ".png");
}
